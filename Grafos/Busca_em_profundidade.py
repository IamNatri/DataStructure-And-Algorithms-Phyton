...
#pilha pra implementação de Busca em profundidade
import numpy as np
...
#implementacao algoritimo de busca em profundidade
...
class BuscaProfundidade:
    ...
    def buscar(self):
        ...
        for adjacente in topo.adjacentes:
            print('topo e {}. {} ja foi visitada? {}'.format(topo.rotulo, adjacente.vertice.rotulo, adjacente.vertice.visitado))
