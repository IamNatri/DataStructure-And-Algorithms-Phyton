...
#criando as linhas e colunas da matriz em forma de dicionario
...
class Dijkstra:
  ...
  def mostra_solucao(self, distancias):
    ...
    #aqui dois vetores são utilizados para informar as distancias e o outro
        #  para armazenar se o nó já foi visitado
